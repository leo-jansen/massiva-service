...
public class UfCidadeController {
  ...
  @GetMapping("/{estado}")
  public ResponseEntity<List<String>> getComboCidade(@PathVariable("estado") String estado) {
    List<String> comboCidade = ufCidadeService.getComboCidade(estado);
    return ResponseEntity.ok(comboCidade);
  }
}
